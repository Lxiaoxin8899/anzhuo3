...
# 归档文档：旧 SmartDosing 智能投料系统 Web 后台管理

## 系统概览

旧 SmartDosing Web 后台管理系统是一个基于 Android 平板的轻量化 Web 服务器方案，面向生产投料阶段。当前项目名称为“快速研发系统”，本文仅作为旧项目资料留存。
...
启动旧 SmartDosing 应用后，系统会自动启动 Web 服务器：
